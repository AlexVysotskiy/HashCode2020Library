...
listResults =[]
listResults.append(score("inputs/me_at_the_zoo.in", "inputs/me_at_the_zoo.in.out"))
listResults.append(score("inputs/videos_worth_spreading.in", "inputs/videos_worth_spreading.in.out"))
listResults.append(score("inputs/trending_today.in", "inputs/trending_today.in.out"))
listResults.append(score("inputs/kittens.in.txt", "inputs/kittens.in.txt.out"))

print("Scores: ", listResults)
print("Total score: ", sum(listResults))
